import { brandConfig, createSampleReview } from "@reviselab/core";
import { AppHeader, ReviewStatusTag } from "@reviselab/ui";
import { Button, Column, Content, Grid, Tag, Tile } from "@reviselab/ui/carbon";

export default function HomePage() {
  const sampleReview = createSampleReview();
          ...
          <Grid fullWidth className="rl-page-grid">
            ...
            <Column sm={4} md={8} lg={6}>
              <Tile className="rl-tile rl-section">
                <h3>Comments</h3>
                <p className="rl-muted">
                  Review comments explain what looks risky, what to clarify, and
                  which source informed the guidance.
                </p>
              </Tile>
            </Column>
          </Grid>
